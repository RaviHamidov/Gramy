...
export default function MoreThanFood({ title, data }) {
    ...
    <>
      <div className="w-full mx-auto pl-8">
        ...
        <Slider {...settings} ref={carouselRef}>
          {data.map((item, index) => {
            return (
            <Link to="/res" className="!w-fit rounded-2xl text-white text-2xl align-center transition-all duration-300 shadow-primary focus:border-none hover:scale-105 m-2 mb-16 mr-2 "
            key={index}>
                <img
                ...
                <div className="w-full flex justify-center items-center p-4 text-[#000]">
