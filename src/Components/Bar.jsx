...
function Bar()
{
    return(
        ...
        <div> 
            <img src={cityLogo} className="inline-block mr-2" alt="building"></img>
          ...
          <div className="flex justify-between">
            <div className="cursor-pointer  hover:bg-sky-500 hover:rounded-2xl bg-sky-400 text-white hover:transition-all hover:text-white hover:duration-1000 bg-gray-200 mr-4 rounded-2xl p-2">
                <img src={exploreLogo} className="inline-block mr-2 " alt="explore"></img>
                <a href="#" className="mr-12 ">Kəşf et</a>
            </div>
            <div className="hover:bg-sky-500 cursor-pointer hover:rounded-2xl  hover:transition-all hover:text-white hover:duration-1000 bg-gray-200 mr-4 rounded-2xl p-2">
                <img src={hamburgerLogo} className="inline-block mr-2" alt="hamburger"></img>
                <a href="#" className="mr-12">Restoranlar</a>
            </div>
            <div className="hover:bg-sky-500 cursor-pointer hover:rounded-2xl  hover:transition-all hover:text-white hover:duration-1000 bg-gray-200 mr-4 rounded-2xl p-2">
              <img src={basketLogo} className="inline-block mr-2" alt="basket"></img>
              <a href="#" className="mr-12">Mağazalar</a>
            </div>
        </div>
      </section>
    )
